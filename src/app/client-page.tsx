...
const featureCards = [
  ...
  { title: "PDF to Word", description: "Lift selectable copy into a styled DOCX handoff with one click.", href: "/pdf-to-word", icon: FileText, palette: "from-sky-400 to-blue-500", badge: "Transcribe", meta: "DOCX" },
  { title: "PDF to PowerPoint", description: "Turn long-form PDFs into slide-ready storyboards instantly.", href: "/pdf-to-powerpoint", icon: Presentation, palette: "from-orange-400 to-rose-500", badge: "Storyboard", meta: "PPTX" },
  { title: "Word to PDF", description: "Lock Word briefs into tamper-proof PDFs before sharing.", href: "/word-to-pdf", icon: FileText, palette: "from-emerald-400 to-teal-500", badge: "Seal", meta: "DOCX -> PDF" },
  { title: "PowerPoint to PDF", description: "Publish slide decks as lightweight PDFs for async reviews.", href: "/powerpoint-to-pdf", icon: Presentation, palette: "from-fuchsia-400 to-purple-500", badge: "Publish", meta: "PPTX -> PDF" },
