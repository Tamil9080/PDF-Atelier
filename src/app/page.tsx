...
const heroStats = [
  {
    label: "Documents optimized",
    value: "2.3M+",
    detail: "processed fully on-device",
  },
...
const featureCards = [
  {
    title: "PDF to Image",
    description: "Slice multipage PDFs into gallery-ready PNG or JPG assets.",
    href: "/pdf-to-image",
    icon: ImageIcon,
    palette: "from-cyan-400 via-sky-400 to-indigo-400",
    badge: "Convert",
    meta: "PNG · JPG",
  },
  {
    title: "Image to PDF",
    description: "Lay out crisp PDF decks from raw shots or mockups in seconds.",
    href: "/image-to-pdf",
    icon: FileText,
    palette: "from-emerald-400 to-lime-400",
    badge: "Assemble",
    meta: "Batch ready",
  },
  {
    title: "Compress PDF",
    description: "Dial in file sizes without crushing typography or brand colors.",
    href: "/pdf-compress",
    icon: Minimize2,
  ...
  },
  {
    ...
    description: "Ship web-speed imagery that still feels print-grade sharp.",
    href: "/image-compress",
    icon: Layers,
    palette: "from-fuchsia-400 to-rose-500",
    badge: "Polish",
    meta: "Web · Mobile",
  },
  {
    title: "Merge PDF",
    description: "Drag multiple PDFs into a single narrative with zero upload.",
    href: "/merge-pdf",
    icon: Merge,
    palette: "from-indigo-400 to-purple-500",
    badge: "Compile",
    meta: "Smart order",
  },
  {
    title: "PDF to Word",
    description: "Lift selectable copy into a styled DOCX handoff with one click.",
    href: "/pdf-to-word",
    icon: FileText,
  ...
  },
  {
    ...
    description: "Turn long-form PDFs into slide-ready storyboards instantly.",
    href: "/pdf-to-powerpoint",
    icon: Presentation,
    palette: "from-orange-400 to-rose-500",
    badge: "Storyboard",
    meta: "PPTX",
  },
  {
    title: "Word to PDF",
    description: "Lock Word briefs into tamper-proof PDFs before sharing.",
    href: "/word-to-pdf",
    icon: FileText,
  ...
  },
  {
    ...
    description: "Publish slide decks as lightweight PDFs for async reviews.",
    href: "/powerpoint-to-pdf",
    icon: Presentation,
    palette: "from-fuchsia-400 to-purple-500",
    badge: "Publish",
    meta: "PPTX -> PDF",
  },
  {
    title: "Split PDF",
    description: "Extract custom ranges into perfectly packaged ZIP bundles.",
    href: "/pdf-split",
    icon: Scissors,
  ...
  {
    title: "Rotate PDF",
    description: "Fix sideways scans in bulk with one precise rotation.",
    href: "/pdf-rotate",
    icon: RotateCcw,
  ...
  {
    title: "Add Watermark",
    description: "Lay diagonal brand watermarks with tunable opacity per page.",
    href: "/pdf-watermark",
    icon: Droplets,
    palette: "from-indigo-400 to-violet-500",
    badge: "Secure",
    meta: "Text layer",
  },
  {
    title: "Protect PDF",
    description: "Encrypt documents with user/owner passwords and rules.",
    href: "/pdf-protect",
    icon: Shield,
    palette: "from-emerald-400 to-cyan-500",
    badge: "Lock",
    meta: "Permissions",
  },
  {
    title: "Unlock PDF",
    description: "Strip passwords (with authorization) for easier sharing.",
    href: "/pdf-unlock",
    icon: Unlock,
    palette: "from-amber-400 to-orange-500",
    badge: "Unlock",
  ...
  {
    title: "OCR Workspace",
    description: "Run Tesseract.js on scans to export selectable plain text.",
    href: "/ocr",
    icon: ScanText,
    palette: "from-purple-400 to-fuchsia-500",
    badge: "Extract",
    meta: "Tesseract",
  },
  {
    title: "Batch Processing",
    description: "Apply rotate, watermark, or lock actions to entire folders.",
    href: "/batch-processing",
    icon: Settings2,
    palette: "from-sky-400 to-emerald-400",
    badge: "Automate",
    meta: "ZIP output",
  },
];
...
const workflowSteps = [
  {
    ...
    description: "Drag a stack of PDFs or images and we auto-detect intent.",
    badge: "01",
  },
  {
    title: "Tune the outcome",
    description: "Adjust compression, format, margins, and brand presets live.",
    badge: "02",
  },
  {
    title: "Export instantly",
    description: "Processing finishes before your cursor leaves the button.",
    badge: "03",
  },
];
...
const trustSignals = [
  {
    ...
    description: "All conversions run in-browser so nothing ever hits a server.",
    icon: ShieldCheck,
    colors: "from-emerald-400 to-teal-400",
  },
  {
    title: "Encrypted cache",
    description: "Temporary data is sealed and cleared every session automatically.",
    icon: Lock,
    colors: "from-sky-400 to-indigo-400",
  },
  {
    title: "Performance cores",
    description: "Optimized WebAssembly pipelines crunch multi-hundred page docs.",
    icon: Cpu,
  ...
  return (
    <div className="space-y-24">
        ...
        <div className="relative grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/pdf-to-image"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-cyan-400 via-sky-400 to-emerald-400 px-6 py-3 text-base font-semibold text-slate-950 shadow-[0_20px_45px_-25px_rgba(6,182,212,0.8)]"
              >
                Launch Converter
              ...
              <Link
                href="#features"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 px-6 py-3 text-base font-semibold text-slate-100"
              >
                Explore Toolkit
              </Link>
            </div>
          ...
          <div className="relative">
            <div className="rounded-3xl border border-white/10 bg-slate-900/70 p-6 shadow-[0_40px_120px_-60px_rgba(15,118,255,0.8)]">
              ...
              <div className="mt-8 rounded-2xl bg-gradient-to-r from-emerald-400 to-cyan-400 px-5 py-4 text-sm font-semibold text-slate-900">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {featureCards.map((feature) => (
            <Link
              key={feature.title}
              href={feature.href}
              className="group flex flex-col gap-6 rounded-3xl border border-white/10 bg-slate-900/60 p-6 transition-all hover:-translate-y-1 hover:border-cyan-400/50 hover:shadow-[0_25px_60px_-35px_rgba(8,145,178,0.8)]"
            >
              <div className="flex items-center justify-between">
                <span className="text-xs uppercase tracking-[0.3em] text-slate-400">{feature.badge}</span>
                <ArrowUpRight className="h-4 w-4 text-slate-500 group-hover:text-cyan-300" aria-hidden="true" />
              </div>
              <div className="flex items-center gap-4">
                <div className={`flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${feature.palette} text-slate-950 shadow-lg shadow-white/10`}>
              ...
              <span className="text-xs font-semibold uppercase tracking-[0.4em] text-slate-500">Open tool</span>
            </Link>
          ))}
        </div>
      </section>
      ...
      <section className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-[32px] border border-white/10 bg-slate-900/70 p-8">
          ...
          <ol className="mt-8 space-y-6">
            {workflowSteps.map((step) => (
              <li key={step.badge} className="relative rounded-3xl border border-white/5 bg-white/5 p-5 pl-14">
        ...
        <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-slate-950/70 p-8">
          ...
          <div className="relative space-y-6">
            ...
            <ul className="space-y-5">
              {trustSignals.map((signal) => (
                <li key={signal.title} className="flex items-start gap-4 rounded-2xl border border-white/10 bg-white/5 p-4">
                  <div className={`flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${signal.colors} text-slate-950`}>
      ...
      <section className="relative overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 px-8 py-10">
        ...
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="/image-to-pdf"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3 text-base font-semibold text-slate-900"
            >
              Launch Studio
              <ArrowUpRight className="h-4 w-4" aria-hidden="true" />
            </Link>
            <Link
              href="#features"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/30 px-6 py-3 text-base font-semibold text-white"
            >
              Browse features
            </Link>
          </div>
